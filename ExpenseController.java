package com.aishwarya.app.controller;
...
import com.aishwarya.app.model.Expenses;
import com.aishwarya.app.model.User;
import com.aishwarya.app.repository.BalanceRepo;
import com.aishwarya.app.repository.ExpenseRepo;
import com.aishwarya.app.repository.UserRepo;
@Controller
public class ExpenseController {

	long loggedInUser;
@Autowired
private ExpenseRepo xrepo;
...
public ModelAndView displayLogout(ModelAndView modelAndView, com.aishwarya.app.model.User user) {
	modelAndView.addObject("user", user);
	modelAndView.setViewName("login");
	return modelAndView;
}
